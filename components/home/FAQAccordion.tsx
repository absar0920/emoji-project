          ...
          return (
            <AnimatedSection key={i}>
              <div className="border-b border-[var(--line)]">
                ...
                {/* CSS grid-rows 0fr↔1fr collapse — the answer stays in the DOM
                    (better for SEO than unmount-on-close) while height animates. */}
                <div className="fg-collapse" data-open={open}>
                  <div>
