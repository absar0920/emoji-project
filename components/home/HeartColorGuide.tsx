...
export default function HeartColorGuide() {
  return (
    <SectionShell tone="tint" eyebrow="Hearts" title="Heart Emoji Meanings — Every Color Explained" subtitle="Heart emojis are not interchangeable. Each color sends a distinct emotional signal.">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-8">
        {HEARTS.map((h) => (
          <AnimatedSection key={h.emoji}>
            <div className={`${h.bg} ${h.border} border rounded-2xl p-4 shadow-sm card-lift hover:shadow-md hover:border-primary/30`}>
