...
export default function PlatformPageLoading() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-6">
      ...
      <div className="bg-gradient-to-br from-[#EEF2FF] to-[#F5F3FF] dark:from-slate-800 dark:to-indigo-950 rounded-2xl p-6 sm:p-8 mb-6 flex flex-col sm:flex-row items-center gap-6">
